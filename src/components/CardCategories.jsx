...
const CardCategories = ({ categories, title, description, image, onClick, onCategories }) => {
  return (
    <div className="my-1 h-full">
      <div className="lg:h-72 w-full border border-b-2 border-b-brown lg:grid md:grid grid-cols-3 py-5 ">
        <div>
          <h1 className="lg:text-4xl md:text-3xl text-xl font-Inter text-brown font-bold my-5">{categories}</h1>
